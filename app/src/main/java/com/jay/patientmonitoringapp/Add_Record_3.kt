...
class Add_Record_3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val humValEditText = findViewById<TextInputEditText>(R.id.hum_val)
        ...
        saveButton.setOnClickListener {
            ...
            val humVal = humValEditText.text.toString()
            ...
            val recordData = Record_Data_DB3(patientNum, humVal, status, nameday, date, time)
    ...
    private fun saveRecordToFirebase(recordData: Record_Data_DB3) {
        val recordsRef = database.reference.child("UserData").child("Doctor").child(currentDoctorId).child("Records").child("Humidity")
